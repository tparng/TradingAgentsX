...
export const zhTW = {
  ...
  watchlist: {
    title: "自選股清單",
    subtitle: "追蹤股票並定時自動分析",
    addTicker: "新增股票",
    tickerPlaceholder: "例：2330",
    marketLabel: "市場",
    notesLabel: "備註",
    notesPlaceholder: "選填備註",
    syncFromSheet: "從試算表同步",
    analyzeAll: "全部分析",
    analyze: "分析",
    remove: "移除",
    goToAnalysis: "開啟分析",
    ...
    empty: "自選股清單為空，請新增股票或從 Google 試算表同步。",
    syncing: "正在從 Google 試算表同步...",
    syncDone: "同步完成",
    syncError: "同步失敗",
    analyzing: "分析已在背景啟動",
    removeConfirm: "確定要移除 {ticker} 嗎？",
    statusSheets: "Google 試算表：",
    ...
    candidates: {
      title: "AI 選股候選",
      subtitle: "由篩選器偵測並經 AI 排名的推薦標的",
      generate: "產生候選清單",
      generating: "掃描市場中...",
      empty: "尚無候選，點擊「產生候選清單」開始掃描市場。",
      addSelected: "加入自選股",
      addSelectedCount: "加入已選 ({n})",
      dismiss: "略過",
      screened: "篩選時間",
      priceChange: "當日漲跌",
      volRatio: "量比",
      ...
      addedToast: "已新增 {n} 支股票至自選股",
      alreadyInWatchlist: "已在自選股中",

      settings: {
        title: "篩選器設定",
        stage1: "第一階段 — 規則篩選",
        minPriceChange: "最低 |漲跌幅|",
        minPriceChangeHint: "單日漲跌幅超過此值才進入候選池",
        minVolumeRatio: "最低量比",
        minVolumeRatioHint: "當日成交量與 20 日均量之比",
        priceWeight: "評分權重 — 漲跌幅",
        priceWeightHint: "量比權重 = 1 − 漲跌幅權重",
        universe: "股票範圍",
        includeUS: "美股",
        includeTW: "台股（上市）",
        maxCandidates: "傳入 AI 的最大候選數",
        maxCandidatesHint: "篩選後取前 N 名送給 AI 排名",
        stage2: "第二階段 — AI 排名",
        llmTopN: "AI 回傳前幾名",
        llmTopNHint: "AI 最終選出的候選數量",
        reset: "重設為預設值",
      },
      ...
      detail: {
        title: "{ticker} — AI 分析",
        generating: "正在產生分析報告...",
        generatingHint: "約需 20–40 秒",
        currentPrice: "現價",
        range30d: "30日區間",
        noReport: "分析報告無法產生，請確認 AI 模型是否正在運行。",
        addToWatchlist: "加入自選股",
        dismiss: "略過",
        openFullAnalysis: "完整分析",
        metrics: "篩選指標",
      },
    },
  },
