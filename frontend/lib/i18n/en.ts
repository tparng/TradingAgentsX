...
export const en = {
  ...
  watchlist: {
    title: "Watchlist",
    subtitle: "Track stocks and auto-analyze them on a schedule",
    ...
    empty: "No tickers in watchlist yet. Add one above or sync from Google Sheet.",
    syncing: "Syncing from Google Sheet...",
    syncDone: "Sync complete",
    syncError: "Sync failed",
    analyzing: "Analysis started in background",
    removeConfirm: "Remove {ticker} from watchlist?",
    statusSheets: "Google Sheets: ",
    ...
    candidates: {
      title: "AI Candidates",
      subtitle: "Stocks flagged by the screener and ranked by AI",
      generate: "Generate Candidates",
      generating: "Scanning markets...",
      empty: "No candidates yet. Click \"Generate Candidates\" to scan the market.",
      addSelected: "Add Selected",
      addSelectedCount: "Add Selected ({n})",
      dismiss: "Dismiss",
      screened: "Screened",
      priceChange: "1d Change",
      volRatio: "Vol Ratio",
      rsi: "RSI",
      signal: {
        BULLISH: "Bullish",
      ...
      addedToast: "Added {n} ticker(s) to watchlist",
      alreadyInWatchlist: "Already in watchlist",

      settings: {
        title: "Screener Settings",
        stage1: "Stage 1 — Rule Filter",
        minPriceChange: "Min |price change|",
        minPriceChangeHint: "1-day move threshold to enter candidate pool",
        minVolumeRatio: "Min volume ratio",
        minVolumeRatioHint: "Today's volume vs 20-day average",
        priceWeight: "Score weight — price change",
        priceWeightHint: "Volume weight = 1 − price weight",
        universe: "Universe",
        includeUS: "US stocks",
        includeTW: "TW stocks (TWSE)",
        maxCandidates: "Max candidates → LLM",
        maxCandidatesHint: "Top-N from screener passed to AI ranking",
        stage2: "Stage 2 — LLM Ranking",
        llmTopN: "LLM returns top",
        llmTopNHint: "Number of final candidates the AI picks",
      ...
      detail: {
        ...
        range30d: "30d Range",
        noReport: "Analysis unavailable. Is the AI model running?",
        addToWatchlist: "Add to Watchlist",
        dismiss: "Dismiss",
        openFullAnalysis: "Full Analysis",
